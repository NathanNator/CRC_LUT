 ...
 */
module tb_crc_enc_to_dec_32_noise();
    ...
    reg [DATA_IN_WIDTH_ENC + CRC_POLY_WIDTH - 1:0] data_out_noise;
    ...
    initial begin
        ...
        // Add Some Noise 
        data_out_noise = data_out_enc;
        data_out_noise[1] = ~data_out_noise[1];

        #1; $display("ENCODER: data_out_noise = %h, remainder_out = %h", data_out_noise, remainder_out_enc);
